...
import { useSensorEdit } from '@/hooks/useSensorEdit'
...
export default function SensorsPage() {
  ...
  const { editTarget, editSensorPositions, autoInitValues, openEdit, closeEdit } =
    useSensorEdit(setForm, formulas, showToast)
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-surface-page">
      ...
      {editTarget && <SensorModal mode="edit" form={form} onChange={setForm} onSubmit={handleEdit} onClose={closeEdit} formulas={formulas} sites={sites} sensorPositions={editSensorPositions} sensorId={editTarget.id} />}
